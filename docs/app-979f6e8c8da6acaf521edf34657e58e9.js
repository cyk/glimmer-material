...
return e}function u(t){return t._guid=++Me}function p(t){return t._guid||u(t)}function c(){}function h(){return new c}function l(t){var e=Ke.length
...
default:return sn.create(t)}}function v(t,e){return new cn(t,e)}function g(t){return t!==ln}function b(t){return t.tag===Ze}function _(t){return"function"!=typeof t.toString?"":String(t)}function k(t){for(var e=[],n=0;n<t.length;n++){var i=t[n].value()
!1!==i&&null!==i&&void 0!==i&&e.push(i)}return 0===e.length?null:e.join(" ")}function S(t){return JSON.stringify("<"+t.tagName.toLowerCase()+" />")}function w(t,e){return new Qn(t,e)}function E(t,e){for(var n=t.parentElement(),i=t.firstNode(),r=t.lastNode(),o=i;o;){var s=o.nextSibling
...
if(O(n))return fi.insert(t,e,n)
throw r()}function R(t){return null===t||void 0===t||"function"!=typeof t.toString}function M(t){return R(t)?"":String(t)}function B(t){return R(t)?"":x(t)?t:N(t)?t.toHTML():O(t)?t:String(t)}function L(t){return R(t)?"":x(t)?t:N(t)||O(t)?t:String(t)}function F(t,e){console.info("Use `context`, and `get(<path>)` to debug this template."),e("this")}function I(t){return function(e){return Array.isArray(e)&&e[0]===t}}function P(t,e){var n=new Ti(e)
...
H(r,n),o?n.dynamicAttrNS(i,o,e):n.dynamicAttr(i,e)}function H(t,e){Array.isArray(t)?Xi.compile(t,e):e.primitive(t)}function z(t,e){if(!t)return 0
...
return function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.insertHTMLBefore=function(e,i,r){if(null===r||""===r)return t.prototype.insertHTMLBefore.call(this,e,i,r)
...
return function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.insertHTMLBefore=function(e,r,o){return null===o||""===o?t.prototype.insertHTMLBefore.call(this,e,r,o):e.namespaceURI!==n?t.prototype.insertHTMLBefore.call(this,e,r,o):st(e,i,o,r)},e}(e)}function st(t,e,n,i){var r="<svg>"+n+"</svg>"
e.innerHTML=r
...
var i=Se(this,t.call(this,n))
return i.uselessComment=i.createComment(""),i}return ke(e,t),e.prototype.insertHTMLBefore=function(e,n,i){if(null===i)return t.prototype.insertHTMLBefore.call(this,e,n,i)
...
return r||(r=JSON.parse(i)),new Yr(o,a,t,r)}}}function kt(){}function St(t){return-1===t.indexOf(":")}function wt(t,e,n,i,r){var o=[t.slice(0,1),null,null,null],s=[t.slice(1),Ct(e),n,i]
...
try{return JSON.stringify(t)}catch(t){}return t.toString()}function Dt(t){return function(e,n){return new fo(t,n)}}function Rt(t,e){t.add("component",wt),e.add("component",Et)}function Mt(t){return void 0!==t.createComponentDefinition}function Bt(){}function Lt(t){var e=t.split(":"),n=e[0],i=e[1]
return!!(n&&i&&0===i.indexOf("/")&&i.split("/").length>3)}function Ft(t){return void 0!==t.rootName&&void 0!==t.collection&&void 0!==t.name&&void 0!==t.type}function It(t){var e=t.type,n=Pt(t)
...
return Ft(t)&&(n="/"+n),n}}function jt(t){var e={}
...
return e&&Jt(t,wo)?e:t[wo]=new So(e)}function Jt(t,e){return Eo.call(t,e)}function Yt(t,e){arguments.length>2&&void 0!==arguments[2]&&arguments[2]
if("object"===(void 0===t?"undefined":ge(t))&&t){return Wt(t).tagFor(e)}return Ze}function Xt(t,e){throw new Co(t,e,"The '"+e+"' property on the "+t+" was changed after it had been rendered. Properties that change after being rendered must be tracked. Use the @tracked decorator to mark this as a tracked property.")}function qt(){var t=Po(null)
...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),ke=function(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e)
t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)},Se=function(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
...
var Te=ve.Debug,De=new Oe({console:xe,level:Te}),Re=Object.keys,Me=0,Be=Object.create(null,{constructor:{value:void 0,enumerable:!1,writable:!0}})
c.prototype=Be
var Le=function(){function t(){be(this,t),this.dict=h()}return t.prototype.add=function(t){return"string"==typeof t?this.dict[t]=t:this.dict[p(t)]=t,this},t.prototype.delete=function(t){"string"==typeof t?delete this.dict[t]:t._guid&&delete this.dict[t._guid]},t.prototype.forEach=function(t){for(var e=this.dict,n=Object.keys(e),i=0;n.length;i++)t(e[n[i]])},t.prototype.toArray=function(){return Object.keys(this.dict)},t}(),Fe=function(){function t(){be(this,t),this.stack=[],this.current=null}return t.prototype.toArray=function(){return this.stack},t.prototype.push=function(t){this.current=t,this.stack.push(t)},t.prototype.pop=function(){var t=this.stack.pop(),e=this.stack.length
return this.current=0===e?null:this.stack[e-1],void 0===t?null:t},t.prototype.isEmpty=function(){return 0===this.stack.length},t}(),Ie=function t(e){be(this,t),this.next=null,this.prev=null,this.value=e},Pe=function(){function t(){be(this,t),this.clear()}return t.fromSlice=function(e){var n=new t
...
var Ge=function(){function t(){be(this,t),this.evaluateOpcode=a(71).slice()}return t.prototype.add=function(t,e){this.evaluateOpcode[t]=e},t.prototype.evaluate=function(t,e,n){(0,this.evaluateOpcode[n])(t,e)},t}(),We=new Ge,Je=function(){function t(){be(this,t),u(this)}return t.prototype.toJSON=function(){return{guid:this._guid,type:this.type}},t}(),Ye=function(t){function e(){be(this,e)
var n=Se(this,t.apply(this,arguments))
return n.next=null,n.prev=null,n}return ke(e,t),e}(Je),Xe=1,qe=function(){function t(){be(this,t)}return t.prototype.validate=function(t){return this.value()===t},t}()
qe.id=0
...
var en=(new Qe(2,null),Xe),nn=function(t){function e(){var n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:en
be(this,e)
var i=Se(this,t.call(this))
return i.revision=n,i}return ke(e,t),e.create=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:en
...
var n=Se(this,t.apply(this,arguments))
return n.lastChecked=null,n.lastValue=null,n}return ke(e,t),e.prototype.value=function(){var t=this.lastChecked
this.lastValue
...
var r=Se(this,t.call(this))
return r.first=n,r.second=i,r}return ke(e,t),e.create=function(t,n){return new Qe(this.id,new e(t,n))},e.prototype.compute=function(){return Math.max(this.first.value(),this.second.value())},e}(rn)
l(on)
var sn=function(t){function e(n){be(this,e)
var i=Se(this,t.call(this))
return i.tags=n,i}return ke(e,t),e.create=function(t){return new Qe(this.id,new e(t))},e.prototype.compute=function(){for(var t=this.tags,e=-1,n=0;n<t.length;n++){var i=t[n].value()
e=Math.max(i,e)}return e},e}(rn)
l(sn)
var an=function(t){function e(n){be(this,e)
var i=Se(this,t.call(this))
return i.tag=n,i.lastUpdated=Xe,i}return ke(e,t),e.create=function(t){return new Qe(this.id,new e(t))},e.prototype.compute=function(){return Math.max(this.lastUpdated,this.tag.value())},e.prototype.update=function(t){t!==this.tag&&(this.tag=t,this.lastUpdated=en,this.invalidate())},e}(rn)
l(an)
...
var r=Se(this,t.call(this))
return r.tag=n.tag,r.reference=n,r.mapper=i,r}return ke(e,t),e.prototype.compute=function(){var t=this.reference
...
var i=n
return this.current=t.nextNode(i),i.shouldRemove()?(t.remove(i),e.delete(i.key)):i.reset(),un.Prune},t.prototype.nextDone=function(){this.target.done()},t}(),gn=function(t){function e(n){return be(this,e),Se(this,t.call(this,n))}return ke(e,t),e.create=function(t){return void 0===t?kn:null===t?Sn:!0===t?wn:!1===t?En:"number"==typeof t?new _n(t):new bn(t)},e.prototype.get=function(t){return kn},e}(fn),bn=function(t){function e(){be(this,e)
var n=Se(this,t.apply(this,arguments))
return n.lengthReference=null,n}return ke(e,t),e.prototype.get=function(e){if("length"===e){var n=this.lengthReference
return null===n&&(n=this.lengthReference=new _n(this.inner.length)),n}return t.prototype.get.call(this,e)},e}(gn),_n=function(t){function e(n){return be(this,e),Se(this,t.call(this,n))}return ke(e,t),e}(gn),kn=new _n(void 0),Sn=new _n(null),wn=new _n(!0),En=new _n(!1),An=function(){function t(e){be(this,t),this.inner=e,this.tag=e.tag}return t.prototype.value=function(){return this.toBool(this.inner.value())},t.prototype.toBool=function(t){return!!t},t}(),Cn=function(t){function e(n){be(this,e)
var i=Se(this,t.call(this))
return i.parts=n,i.tag=f(n),i}return ke(e,t),e.prototype.compute=function(){for(var t=new Array,e=0;e<this.parts.length;e++){var n=this.parts[e].value()
...
var i=parseInt(t,10)
return i<0||i>=n?kn:e[i]},t.prototype.valueOf=function(t){return t.value()},t}(),Tn=function(){function t(){be(this,t),this.length=0,this._tag=null,this._references=null,this._names=null,this._realNames=ze}return t.prototype.setup=function(t,e,n,i){this.stack=t,this.length=e,this._tag=null,this._references=null,i?(this._names=n,this._realNames=ze):(this._names=null,this._realNames=n)},t.prototype.has=function(t){return-1!==this.names.indexOf(t)},t.prototype.get=function(t){var e=this.names,n=this.length,i=e.indexOf(t)
if(-1===i)return kn
var r=n-i
...
return-1===i?kn:n[i]},t.prototype.value=function(){for(var t=this.names,e=this.references,n=h(),i=0;i<t.length;i++){n[t[i]]=e[i].value()}return n},_e(t,[{key:"map",get:function(){var t=this._map
...
r.peek()&&t.goto(n),t.updateWith(new Fn(r))}}),We.add(45,function(t,e){var n=e.op1,i=t.stack.pop()
if(b(i))i.value()||t.goto(n)
else{var r=new hn(i)
r.peek()||t.goto(n),t.updateWith(new Fn(r))}}),We.add(22,function(t){return t.return()})
var Mn=function(t,e){return new fn(!!t.value())},Bn=function(t,e){return t},Ln=function(t,e){return e.toConditionalReference(t)}
We.add(50,function(t,e){var n=e.op1,i=t.stack,r=i.pop(),o=t.constants.getFunction(n)
i.push(o(r,t.env))})
var Fn=function(t){function e(n){be(this,e)
var i=Se(this,t.call(this))
return i.type="assert",i.tag=n.tag,i.cache=n,i}return ke(e,t),e.prototype.evaluate=function(t){g(this.cache.revalidate())&&t.throw()},e.prototype.toJSON=function(){var t=this.type,e=this._guid,n=this.cache,i=void 0
try{i=JSON.stringify(n.peek())}catch(t){i=String(n.peek())}return{args:[],details:{expected:i},guid:e,type:t}},e}(Ye),In=function(t){function e(n,i){be(this,e)
var r=Se(this,t.call(this))
return r.target=i,r.type="jump-if-not-modified",r.tag=n,r.lastRevision=n.value(),r}return ke(e,t),e.prototype.evaluate=function(t){var e=this.tag,n=this.target,i=this.lastRevision
!t.alwaysRevalidate&&e.validate(i)&&t.goto(n)},e.prototype.didModify=function(){this.lastRevision=this.tag.value()},e.prototype.toJSON=function(){return{args:[JSON.stringify(this.target.inspect())],guid:this._guid,type:this.type}},e}(Ye),Pn=function(t){function e(n){be(this,e)
var i=Se(this,t.call(this))
return i.target=n,i.type="did-modify",i.tag=Ze,i}return ke(e,t),e.prototype.evaluate=function(){this.target.didModify()},e}(Ye),jn=function(){function t(e){be(this,t),this.tag=Ze,this.type="label",this.label=null,this.prev=null,this.next=null,u(this),this.label=e}return t.prototype.evaluate=function(){},t.prototype.inspect=function(){return this.label+" ["+this._guid+"]"},t.prototype.toJSON=function(){return{args:[JSON.stringify(this.inspect())],guid:this._guid,type:this.type}},t}()
...
i=o.peek(),t.updateWith(new Fn(o))}if(b(n))r=n.value()
else{var s=new hn(n)
r=s.peek(),t.updateWith(new Fn(s))}t.elements().pushRemoteElement(i,r)}),We.add(36,function(t){return t.elements().popRemoteElement()})
...
return t?e?gn.create(k(t)):new Vn(t):Sn},t}(),Vn=function(t){function e(n){be(this,e)
var i=Se(this,t.call(this))
return i.list=[],i.tag=f(n),i.list=n,i}return ke(e,t),e.prototype.compute=function(){return k(this.list)},e}(pn),Hn=function(){function t(e){be(this,t),this.env=e,this.opcodes=null,this.classList=null}return t.prototype.addStaticAttribute=function(t,e,n){"class"===e?this.addClass(gn.create(n)):this.env.getAppendOperations().setAttribute(t,e,n)},t.prototype.addStaticAttributeNS=function(t,e,n,i){this.env.getAppendOperations().setAttribute(t,n,i,e)},t.prototype.addDynamicAttribute=function(t,e,n,i){if("class"===e)this.addClass(n)
...
return this.attributeManager.setAttribute(t,n,o,this.namespace),new Yn(this)},t.prototype.toJSON=function(){var t=this.element,e=this.namespace,n=this.name,r=this.cache,o=S(t),s=i(r,"must serialize after flush").peek()
...
var Yn=function(t){function e(n){be(this,e)
var i=Se(this,t.call(this))
return i.type="patch-element",i.tag=n.tag,i.operation=n,i}return ke(e,t),e.prototype.evaluate=function(t){this.operation.patch(t.env)},e.prototype.toJSON=function(){var t=this._guid,e=this.type
return{details:this.operation.toJSON(),guid:t,type:e}},e}(Ye)
...
e.push({definition:r,manager:r.manager,component:null}),i&&t.updateWith(new Fn(i))}),We.add(57,function(t,e){var n=e.op1,i=t.stack
...
p.component=h,t.updateWith(new Xn(a.tag,o.name,h,s,u))}),We.add(60,function(t,e){var n=e.op1,i=t.fetchValue(n),r=i.manager,o=i.component,s=r.getDestructor(o)
...
if(t&&t.length)for(var e=0;e<t.length;e++)t[e].destroy()},t.prototype.parentElement=function(){return this.parent},t.prototype.firstNode=function(){return this.first&&this.first.firstNode()},t.prototype.lastNode=function(){return this.last&&this.last.lastNode()},t.prototype.openElement=function(t){this.newNode(t),this.nesting++},t.prototype.closeElement=function(){this.nesting--},t.prototype.newNode=function(t){0===this.nesting&&(this.first||(this.first=new Zn(t)),this.last=new ti(t))},t.prototype.newBounds=function(t){0===this.nesting&&(this.first||(this.first=t),this.last=t)},t.prototype.newDestroyable=function(t){this.destroyables=this.destroyables||[],this.destroyables.push(t)},t.prototype.finalize=function(t){this.first||t.appendComment("")},t}(),ri=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.destroy=function(){t.prototype.destroy.call(this),A(this)},e}(ii),oi=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.reset=function(t){var e=this.destroyables
...
var r=Se(this,t.call(this,n))
return r.textNode=i,r}return ke(e,t),e.insert=function(t,n,i){var r=t.createTextNode(i)
return t.insertBefore(n.element,r,n.nextSibling),new e(new Qn(n.element,r),r)},e.prototype.update=function(t,e){if(x(e)){return this.textNode.nodeValue=e,!0}return!1},e}(pi),hi=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.insert=function(t,n,i){return new e(t.insertHTMLBefore(n.element,n.nextSibling,i))},e.prototype.update=function(t,e){if(x(e)){var n=this.bounds,i=n.parentElement(),r=A(n)
return this.bounds=t.insertHTMLBefore(i,r,e),!0}return!1},e}(pi),li=function(t){function e(n,i){be(this,e)
var r=Se(this,t.call(this,n))
return r.lastStringValue=i,r}return ke(e,t),e.insert=function(t,n,i){var r=i.toHTML()
...
o.newBounds(a),r&&t.updateWith(this.updateWith(t,e,r,a,s))},t}(),mi=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.create=function(t){return new e(t)},e.prototype.toBool=function(t){return C(t)},e}(An),yi=function(t){function e(n,i,r){be(this,e)
var o=Se(this,t.call(this))
return o.cache=n,o.bounds=i,o.upsert=r,o.tag=n.tag,o}return ke(e,t),e.prototype.evaluate=function(t){var e=this.cache.revalidate()
...
return{details:{lastValue:JSON.stringify(n.peek())},guid:t,type:e}},e}(Ye),vi=function(t){function e(){be(this,e)
var n=Se(this,t.apply(this,arguments))
return n.type="optimized-cautious-append",n}return ke(e,t),e.prototype.normalize=function(t){return v(t,L)},e.prototype.insert=function(t,e,n){return T(t,e,n)},e.prototype.updateWith=function(t,e,n,i,r){return new gi(n,i,r)},e}(di),gi=function(t){function e(){be(this,e)
var n=Se(this,t.apply(this,arguments))
return n.type="optimized-cautious-update",n}return ke(e,t),e.prototype.insert=function(t,e,n){return T(t,e,n)},e}(yi),bi=function(t){function e(){be(this,e)
var n=Se(this,t.apply(this,arguments))
return n.type="optimized-trusting-append",n}return ke(e,t),e.prototype.normalize=function(t){return v(t,B)},e.prototype.insert=function(t,e,n){return D(t,e,n)},e.prototype.updateWith=function(t,e,n,i,r){return new _i(n,i,r)},e}(di),_i=function(t){function e(){be(this,e)
var n=Se(this,t.apply(this,arguments))
return n.type="optimized-trusting-update",n}return ke(e,t),e.prototype.insert=function(t,e,n){return D(t,e,n)},e}(yi),ki=F,Si=function(){function t(e,n,i){be(this,t),this.scope=e,this.locals=h()
...
We.add(70,function(t,e){var n=e.op1,i=e.op2,r=t.constants.getOther(n),o=t.constants.getArray(i),s=new Si(t.scope(),r,o)
ki(t.getSelf().value(),function(t){return s.get(t).value()})}),We.add(68,function(t){var e=t.stack,n=e.pop()
...
var Ai;(function(t){function e(t){return null===t||"object"!==(void 0===t?"undefined":ge(t))}t.isUnknown=I(Ei.Unknown),t.isGet=I(Ei.Get),t.isConcat=I(Ei.Concat),t.isHelper=I(Ei.Helper),t.isHasBlock=I(Ei.HasBlock),t.isHasBlockParams=I(Ei.HasBlockParams),t.isUndefined=I(Ei.Undefined),t.isClientSide=I(Ei.ClientSideExpression),t.isMaybeLocal=I(Ei.MaybeLocal),t.isPrimitiveValue=e})(Ai||(Ai={}))
var Ci;(function(t){function e(t){return t[0]===Ei.StaticAttr||t[0]===Ei.DynamicAttr||t[0]===Ei.TrustingAttr}function n(t){return t[0]===Ei.StaticArg||t[0]===Ei.DynamicArg}function i(t){return e(t)||n(t)}function r(t){return t[1]}t.isText=I(Ei.Text),t.isAppend=I(Ei.Append),t.isComment=I(Ei.Comment),t.isModifier=I(Ei.Modifier),t.isBlock=I(Ei.Block),t.isComponent=I(Ei.Component),t.isOpenElement=I(Ei.OpenElement),t.isFlushElement=I(Ei.FlushElement),t.isCloseElement=I(Ei.CloseElement),t.isStaticAttr=I(Ei.StaticAttr),t.isDynamicAttr=I(Ei.DynamicAttr),t.isYield=I(Ei.Yield),t.isPartial=I(Ei.Partial),t.isDynamicArg=I(Ei.DynamicArg),t.isStaticArg=I(Ei.StaticArg),t.isTrustingAttr=I(Ei.TrustingAttr),t.isDebugger=I(Ei.Debugger),t.isClientSide=I(Ei.ClientSideStatement),t.isAttribute=e,t.isArgument=n,t.isParameter=i,t.getParameterName=r})(Ci||(Ci={}))
...
var Oi=function t(e,n){be(this,t),this.start=e,this.end=n},xi=function t(e,n,i){be(this,t),this.start=e,this.end=n,this.symbolTable=i},Ti=function(){function t(e){be(this,t),this.env=e}return t.prototype.wrapLayout=function(t){this.inner=new Di(this.env,t)},t.prototype.fromLayout=function(t,e){this.inner=new Ri(this.env,t,e)},t.prototype.compile=function(){return this.inner.compile()},_e(t,[{key:"tag",get:function(){return this.inner.tag}},{key:"attrs",get:function(){return this.inner.attrs}}]),t}(),Di=function(){function t(e,n){be(this,t),this.env=e,this.layout=n,this.tag=new Mi,this.attrs=new Bi}return t.prototype.compile=function(){var t=this.env,e=this.layout,n={templateMeta:e.meta,symbols:e.symbols,asPartial:!1},i=this.tag.getDynamic(),r=this.tag.getStatic(),o=j(t,n)
...
return new xi(u,p,{meta:n,hasEval:e.hasEval,symbols:e.symbols.concat([Vi])})},t}(),Ri=function(){function t(e,n,i){be(this,t),this.env=e,this.componentName=n,this.layout=i,this.attrs=new Bi}return t.prototype.compile=function(){var t=this.env
return this.layout.asLayout(this.componentName,this.attrs.buffer).compileDynamic(t)},_e(t,[{key:"tag",get:function(){throw new Error("BUG: Cannot call `tag` on an UnwrappedBuilder")}}]),t}(),Mi=function(){function t(){be(this,t),this.isDynamic=null,this.isStatic=null,this.staticTagName=null,this.dynamicTagName=null}return t.prototype.getDynamic=function(){if(this.isDynamic)return this.dynamicTagName},t.prototype.getStatic=function(){if(this.isStatic)return this.staticTagName},t.prototype.static=function(t){this.isStatic=!0,this.staticTagName=t},t.prototype.dynamic=function(t){this.isDynamic=!0,this.dynamicTagName=[Ei.ClientSideExpression,Ni.FunctionExpression,t]},t}(),Bi=function(){function t(){be(this,t),this.buffer=[]}return t.prototype.static=function(t,e){this.buffer.push([Ei.StaticAttr,t,e,null])},t.prototype.dynamic=function(t,e){this.buffer.push([Ei.DynamicAttr,t,[Ei.ClientSideExpression,Ni.FunctionExpression,e],null])},t}(),Li=function(){function t(e){be(this,t),this.builder=e,this.env=e.env}return t.prototype.static=function(t,e){var n=e[0],i=e[1],r=e[2],o=e[3],s=this.builder
...
u.startLabels(),u.pushFrame(),u.returnTo("END"),u.compileArgs(t[0],t[1],!0),u.helper(i),u.dup(),u.test("simple"),u.enter(2),u.jumpUnless("ELSE"),u.pushDynamicComponentManager(),u.invokeComponent(null,r,o,s,a),u.label("ELSE"),u.exit(),u.return(),u.label("END"),u.popFrame(),u.stopLabels()},t}(),Fi=function(){function t(e,n,i){be(this,t),this.meta=e,this.statements=n,this.parameters=i}return t.prototype.scan=function(){return new tr(this.statements,{parameters:this.parameters,meta:this.meta})},t}(),Ii=function(){function t(){be(this,t),this.labels=h(),this.targets=[]}return t.prototype.label=function(t,e){this.labels[t]=e},t.prototype.target=function(t,e,n){this.targets.push({at:t,Target:e,target:n})},t.prototype.patch=function(t){for(var e=this.targets,n=this.labels,i=0;i<e.length;i++){var r=e[i],o=r.at,s=r.Target,a=r.target
t.set(o,s,n[a])}},t}(),Pi=function(){function t(e,n,i){be(this,t),this.env=e,this.meta=n,this.program=i,this.labelsStack=new Fe,this.constants=e.constants,this.start=i.next}return t.prototype.upvars=function(t){return a(t)},t.prototype.reserve=function(t){this.push(t,0,0,0)},t.prototype.push=function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0
return this.program.push(t,e,n,i)},t.prototype.finalize=function(){return this.push(22)},t.prototype.pushArgs=function(t){this.push(57,!0===t?1:0)},t.prototype.startLabels=function(){this.labelsStack.push(new Ii)},t.prototype.stopLabels=function(){i(this.labelsStack.pop(),"unbalanced push and pop labels").patch(this.program)},t.prototype.pushComponentManager=function(t){this.push(55,this.other(t))},t.prototype.pushDynamicComponentManager=function(){this.push(56)},t.prototype.prepareArgs=function(t){this.push(58,t)},t.prototype.createComponent=function(t,e,n){var i=(!0===e?1:0)|(!0===n?1:0)<<1
...
be(this,e)
var o=Se(this,t.call(this,n,i,r))
return o.component=new Li(o),o}return ke(e,t),e.prototype.compileArgs=function(t,e,n){var i=0
...
var Yi=function(){function t(e){be(this,t),this.callerCount=e}return t.prototype.invoke=function(t,e){var n=this.callerCount,i=t.stack
...
e.getBlock(n),e.compileDynamicBlock(),e.invokeDynamic(new Yi(r)),e.popScope(),e.popFrame(),r&&e.pop(r)}),zi.add(Ui.Debugger,function(t,e){var n=t[1]
e.debugger(e.meta.symbols,n)}),zi.add(Ui.ClientSideStatement,function(t,e){Gi.compile(t,e)})
var Xi=new Hi,qi=new Hi(1),Ki=Ai
Xi.add(Ui.Unknown,function(t,e){var n=t[1]
e.env.hasHelper(n,e.meta.templateMeta)?Xi.compile([Ui.Helper,n,ze,null],e):e.meta.asPartial?e.resolveMaybeLocal(n):(e.getVariable(0),e.getProperty(n))}),Xi.add(Ui.Concat,function(t,e){for(var n=t[1],i=0;i<n.length;i++)H(n[i],e)
e.concat(n.length)}),qi.add(Ni.FunctionExpression,function(t,e){e.function(t[2])}),Xi.add(Ui.Helper,function(t,e){var n=e.env,i=e.meta,r=t[1],o=t[2],s=t[3]
if(!n.hasHelper(r,i.templateMeta))throw new Error("Compile Error: "+r+" is not a helper")
e.compileArgs(o,s,!0),e.helper(n.lookupHelper(r,i.templateMeta))}),Xi.add(Ui.Get,function(t,e){var n=t[1],i=t[2]
e.getVariable(n)
for(var r=0;r<i.length;r++)e.getProperty(i[r])}),Xi.add(Ui.MaybeLocal,function(t,e){var n=t[1]
if(e.meta.asPartial){var i=n[0]
n=n.slice(1),e.resolveMaybeLocal(i)}else e.getVariable(0)
for(var r=0;r<n.length;r++)e.getProperty(n[r])}),Xi.add(Ui.Undefined,function(t,e){return e.primitive(void 0)}),Xi.add(Ui.HasBlock,function(t,e){e.hasBlock(t[1])}),Xi.add(Ui.HasBlockParams,function(t,e){e.hasBlockParams(t[1])}),Xi.add(Ui.ClientSideExpression,function(t,e){qi.compile(t,e)})
...
this.env.hasComponentDefinition(f,t.templateMeta)?void 0===p&&f===n?(p=f,X(f,o,e,u),Y(l,u)):u.push(l):(void 0!==p?u.push([er.OpenElement,f]):(p=f,X(f,o,e,u)),Y(l,u))}else if(void 0===p&&Ci.isOpenElement(l))p=l[1],c=!0,X(p,o,e,u)
...
var i=Se(this,t.call(this,n))
return i.uselessComment=n.createComment(""),i}return ke(e,t),e.prototype.insertHTMLBefore=function(e,n,i){if(null===i)return t.prototype.insertHTMLBefore.call(this,e,n,i)
var r=!1,o=n?n.previousSibling:e.lastChild
o&&o instanceof Text&&(r=!0,e.insertBefore(this.uselessComment,n))
var s=t.prototype.insertHTMLBefore.call(this,e,n,i)
...
if(!at(t,n))return e
var i=t.createElement("div")
return function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.insertHTMLBefore=function(e,r,o){return null===o||""===o?t.prototype.insertHTMLBefore.call(this,e,r,o):e.namespaceURI!==n?t.prototype.insertHTMLBefore.call(this,e,r,o):st(e,i,o,r)},e}(e)}(yr,br,lr)
var _r,kr=br,Sr=mr.DOMTreeConstruction,wr=function(){function t(e){be(this,t),this.attr=e}return t.prototype.setAttribute=function(t,e,n,i){var r=t.getAppendOperations(),o=yt(n)
vt(o)||r.setAttribute(e,this.attr,o,i)},t.prototype.updateAttribute=function(t,e,n,i){null===n||void 0===n||!1===n?i?t.getDOM().removeAttributeNS(e,i,this.attr):t.getDOM().removeAttribute(e,this.attr):this.setAttribute(t,e,n)},t}(),Er=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.setAttribute=function(t,e,n,i){vt(n)||(e[this.attr]=n)},e.prototype.removeAttribute=function(t,e,n){var i=this.attr
n?t.getDOM().removeAttributeNS(e,n,i):t.getDOM().removeAttribute(e,i)},e.prototype.updateAttribute=function(t,e,n,i){e[this.attr]=n,vt(n)&&this.removeAttribute(t,e,i)},e}(wr),Ar=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.setAttribute=function(e,n,i){t.prototype.setAttribute.call(this,e,n,Z(e,n,this.attr,i))},e.prototype.updateAttribute=function(e,n,i){t.prototype.updateAttribute.call(this,e,n,Z(e,n,this.attr,i))},e}(Er),Cr=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.setAttribute=function(t,e,n){e.value=M(n)},e.prototype.updateAttribute=function(t,e,n){var i=e,r=i.value,o=M(n)
r!==o&&(i.value=o)},e}(wr),Nr=new Cr("value"),Or=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.setAttribute=function(t,e,n){if(null!==n&&void 0!==n&&!1!==n){e.selected=!0}},e.prototype.updateAttribute=function(t,e,n){var i=e
i.selected=!!n},e}(Er),xr=new Or("selected"),Tr=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.setAttribute=function(e,n,i){t.prototype.setAttribute.call(this,e,n,Z(e,n,this.attr,i))},e.prototype.updateAttribute=function(e,n,i,r){t.prototype.updateAttribute.call(this,e,n,Z(e,n,this.attr,i))},e}(wr),Dr=function(){function t(e,n,i,r){be(this,t),this.slots=e,this.callerScope=n,this.evalScope=i,this.partialMap=r}return t.root=function(e){for(var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,i=new Array(n+1),r=0;r<=n;r++)i[r]=kn
...
g.update(b)}},t}(),Mr=function(){function t(e){be(this,t),this.array=e,this.offset=0}return _e(t,[{key:"type",get:function(){return this.array[this.offset]}},{key:"op1",get:function(){return this.array[this.offset+1]}},{key:"op2",get:function(){return this.array[this.offset+2]}},{key:"op3",get:function(){return this.array[this.offset+3]}}]),t}(),Br=function(){function t(){be(this,t),this.opcodes=[],this._offset=0,this._opcode=new Mr(this.opcodes)}return t.prototype.opcode=function(t){return this._opcode.offset=t,this._opcode},t.prototype.set=function(t,e){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0,r=arguments.length>4&&void 0!==arguments[4]?arguments[4]:0
...
return n||(n=e.details={}),t.prototype.toJSON.call(this)},e}(Ir),jr=function(){function t(e,n){be(this,t),this.opcode=e,this.marker=n,this.didInsert=!1,this.didDelete=!1,this.map=e.map,this.updating=e.children}return t.prototype.insert=function(t,e,n,i){var r=this.map,o=this.opcode,s=this.updating,a=null,u=null
...
var a=Se(this,t.call(this,n,i,r,o))
a.type="list-block",a.map=h(),a.lastIterated=Xe,a.artifacts=s
var u=a._tag=an.create(Ze)
return a.tag=m([s.tag,u]),a}return ke(e,t),e.prototype.didInitializeChildren=function(){var t=!(arguments.length>0&&void 0!==arguments[0])||arguments[0]
...
return r||(r=e.details={}),r.map="{"+i+"}",e},e}(Ir),Vr=function(){function t(e,n,i){be(this,t),this.vm=e,this.ops=n,this.exceptionHandler=i,this.vm=e,this.ops=n,this.current=n.head()}return t.prototype.goto=function(t){this.current=t},t.prototype.nextStatement=function(){var t=this.current,e=this.ops
...
e.set(i,this.stack.pop())}},_e(t,[{key:"fp",get:function(){return this.stack.fp},set:function(t){this.stack.fp=t}},{key:"sp",get:function(){return this.stack.sp},set:function(t){this.stack.sp=t}}]),t}(),Wr=function(){function t(e){be(this,t),this.vm=e}return t.prototype.next=function(){return this.vm.next()},t}(),Jr=0,Yr=function(){function t(e,n,i,r){be(this,t),this.id=e,this.meta=n,this.env=i,this.entryPoint=null,this.layout=null,this.partial=null,this.block=null,this.scanner=new nr(r,i),this.symbols=r.symbols,this.hasEval=r.hasEval}return t.prototype.render=function(t,e,n){var i=this.env,r=ni.forInitialRender(i,e,null),o=this.asEntryPoint().compileDynamic(i),s=Gr.initial(i,t,n,r,o)
...
var Xr=function(){function t(e,n){be(this,t),this.cache=kt,this.inner=null,this.chains=null,this.lastParentValue=kt,this._guid=0,this.tag=tn,this.parent=e,this.property=n}return t.prototype.value=function(){var t=this.lastParentValue,e=this.property,n=this.inner,i=this._parentValue()
...
return t in e?e[t]:e[t]=new Xr(this,t)},t.prototype.chainFor=function(t){var e=this.chains
...
return e._meta=new n(e,{})},t.exists=function(t){return"object"===(void 0===t?"undefined":ge(t))&&t._meta},t.metadataForProperty=function(t){return null},t.prototype.addReference=function(t,e){var n=this.references=this.references||h();(n[t]=n[t]||new Le).add(e)},t.prototype.addReferenceTypeFor=function(t,e){this.referenceTypes=this.referenceTypes||h(),this.referenceTypes[t]=e},t.prototype.referenceTypeFor=function(t){return this.referenceTypes?this.referenceTypes[t]||io:io},t.prototype.removeReference=function(t,e){if(this.references){this.references[t].delete(e)}},t.prototype.getReferenceTypes=function(){return this.referenceTypes=this.referenceTypes||h(),this.referenceTypes},t.prototype.referencesFor=function(t){return this.references?this.references[t]:null},t.prototype.getSlots=function(){return this.slots=this.slots||h()},t.prototype.root=function(){return this.rootCache=this.rootCache||new this.RootReferenceFactory(this.object)},t}(),io=function(){function t(e,n,i){be(this,t),this.tag=tn,this.object=e,this.property=n}return t.prototype.value=function(){return this.object[this.property]},t.prototype.label=function(){return"[reference Property]"},t}(),ro=function(){function t(e,n){be(this,t),this._registry=e,this._resolver=n}return t.prototype.register=function(t,e,n){var i=this._toAbsoluteSpecifier(t)
...
return this._registry.registeredInjections(e)},t.prototype._toAbsoluteSpecifier=function(t,e){return this._resolver.identify(t,e)},t.prototype._toAbsoluteOrTypeSpecifier=function(t){return St(t)?t:this._toAbsoluteSpecifier(t)},t}(),oo=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null
...
return"string"==typeof n?t.getComponentDefinition(n,this.meta):null},t.prototype.get=function(){return kn},t}(),lo=function(){function t(e,n){be(this,t),this.tag=tn,this.parent=e,this.property=n}return t.prototype.value=function(){return this.parent.value()[this.property]},t.prototype.get=function(e){return new t(this,e)},t}(),fo=function(){function t(e,n){be(this,t),this.tag=tn,this.helper=e,this.args=n.capture()}return t.prototype.value=function(){var t=this.helper,e=this.args
return t(e.positional.value(),e.named.value())},t.prototype.get=function(t){return new lo(this,t)},t}(),mo=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.toJSON=function(){return"<default-component-definition name="+this.name+">"},e}(ui),yo={action:Nt},vo=function(n){function i(r){be(this,i)
var o=Se(this,n.call(this,{appendOperations:r.appendOperations,updateOperations:new kr(r.document||document)}))
return o.helpers=h(),o.modifiers=h(),o.components=h(),o.managers=h(),e(o,t(r)),o.uselessAnchor=r.document.createElement("a"),o}return ke(i,n),i.create=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
...
return p=Mt(u)?u.createComponentDefinition(t,a,s):new mo(t,u,s),this.components[e]=p,p},i.prototype.hasHelper=function(t,e){return!!this.lookupHelper(t,e)},i.prototype.lookupHelper=function(e,n){if(yo[e])return yo[e]
...
return Rt(t.blocks,t.inlines),t},i}(Lr),go={id:"UN61+JFU",block:'{"symbols":["root"],"statements":[[4,"each",[[19,0,["roots"]]],[["key"],["id"]],{"statements":[[4,"-in-element",[[19,1,["parent"]]],[["nextSibling"],[[19,1,["nextSibling"]]]],{"statements":[[1,[25,"component",[[19,1,["component"]]],null],false]],"parameters":[]},null]],"parameters":[1]},null]],"hasEval":false}',meta:{specifier:"template:/-application/templates/main"}},bo=function(){function t(e){be(this,t),this._roots=[],this._rootsIndex=0,this._initializers=[],this._initialized=!1,this._rendering=!1,this._rendered=!1,this._scheduled=!1,this._rerender=Bt,this.rootName=e.rootName,this.resolver=e.resolver,this.document=e.document||window.document}return t.prototype.registerInitializer=function(t){this._initializers.push(t)},t.prototype.initRegistry=function(){var t=this._registry=new Ee,e=new ro(this._registry,this.resolver)
...
return Ut("'"+t+"' is not a recognized type",e),e.definitiveCollection},t.prototype._serializeAndVerify=function(t){var e=It(t)
if(this.registry.has(e))return e},t}(),ko=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
be(this,t),this._entries=e}return t.prototype.has=function(t){return t in this._entries},t.prototype.get=function(t){return this._entries[t]},t}(),So=function(){function t(e){be(this,t),this.tags=h(),this.computedPropertyTags=h(),this.trackedProperties=e?Object.create(e.trackedProperties):h(),this.trackedPropertyDependencies=e?Object.create(e.trackedPropertyDependencies):h()}return t.prototype.tagFor=function(t){var e=this.tags[t]
if(e)return e
var n=void 0
...
var n=Se(this,t.apply(this,arguments))
return n.children=h(),n}return ke(e,t),e.prototype.get=function(t){var e=this.children[t]
return e||(e=this.children[t]=new Mo(this.inner,t)),e},e}(fn),Ro=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.create=function(t,e){return b(t)?new Mo(t.value(),e):new Bo(t,e)},e.prototype.get=function(t){return new Bo(this,t)},e}(To),Mo=function(t){function e(n,i){be(this,e)
var r=Se(this,t.call(this))
return r._parentValue=n,r._propertyKey=i,r.tag=Yt(n,i,Xt),r}return ke(e,t),e.prototype.compute=function(){return this._parentValue[this._propertyKey]},e}(Ro),Bo=function(t){function e(n,i){be(this,e)
var r=Se(this,t.call(this)),o=n.tag,s=an.create(Ze)
return r._parentReference=n,r._parentObjectTag=s,r._propertyKey=i,r.tag=m([o,s]),r}return ke(e,t),e.prototype.compute=function(){var t=this._parentReference,e=this._parentObjectTag,n=this._propertyKey,i=t.value()
return e.inner.update(Yt(i,n)),"string"==typeof i&&"length"===n?i.length:"object"===(void 0===i?"undefined":ge(i))&&i?i[n]:void 0},e}(Ro),Lo=(function(t){function e(n){be(this,e)
var i=Se(this,t.call(this))
return i.tag=nn.create(),i._value=n,i}ke(e,t),e.prototype.value=function(){return this._value},e.prototype.update=function(t){t!==this._value&&(this.tag.inner.dirty(),this._value=t)}}(xo),function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}ke(e,t),e.create=function(t){if(b(t)){var n=t.value()
...
e(a,r),this.component=o.create(a)}return t.prototype.namedArgsSnapshot=function(){return Object.freeze(this.args.named.value())},t}()),Fo=function(){function t(e,n){be(this,t),this.template=n,this.name=e}return t.prototype.compile=function(t){t.fromLayout(this.name,this.template)},t}(),Io=function(){function e(t){be(this,e),this.env=t.env}return e.create=function(t){return new e(t)},e.prototype.prepareArgs=function(t,e){return null},e.prototype.create=function(e,n,i){if(!n.componentFactory)return null
var r=t(this.env)
...
t(Kt("",n,this.delegate)),Qt([],n,function(t){e?e(this,t):this.add(t)},this)},Ho=/%|\//g,zo=/%(?:2(?:4|6|B|C)|3(?:B|D|A)|40)/g,Go=/(\/|\.|\*|\+|\?|\||\(|\)|\[|\]|\{|\}|\\)/g,Wo=Array.isArray,Jo=Object.prototype.hasOwnProperty,Yo=[]
Yo[0]=function(t,e){for(var n=e,i=t.value,r=0;r<i.length;r++){var o=i.charCodeAt(r)
n=n.put(o,!1,!1)}return n},Yo[1]=function(t,e){return e.put(47,!0,!0)},Yo[2]=function(t,e){return e.put(-1,!1,!0)},Yo[4]=function(t,e){return e}
var Xo=[]
Xo[0]=function(t){return t.value.replace(Go,"\\$1")},Xo[1]=function(){return"([^/]+)"},Xo[2]=function(){return"(.+)"},Xo[4]=function(){return""}
var qo=[]
...
4!==d.type&&(a=!1,n=n.put(47,!1,!1),i+="/",n=Yo[d.type](d,n),i+=Xo[d.type](d))}o[p]={handler:c.handler,names:l,shouldDecodes:f}}a&&(n=n.put(47,!1,!1),i+="/"),n.handlers=o,n.pattern=i+"$",n.types=r
var m
...
var es=new ts
es.map(function(t){t("/buttons").to("route-buttons"),t("/").to("route-home")})
...
var i=Se(this,t.call(this,n))
return le(function(t,e){i.currentRouteComponent=t,i.params=e}),i}return ke(e,t),_e(e,[{key:"isCurrentRouteHome",get:function(){return"route-home"===this.currentRouteComponent}}]),e}(No)
rs([Vt],os.prototype,"currentRouteComponent",void 0),rs([Vt],os.prototype,"params",void 0),rs([Vt("currentRouteComponent")],os.prototype,"isCurrentRouteHome",null)
var ss={id:"rsR8AFZD",block:'{"symbols":[],"statements":[[6,"div"],[9,"class","glimmer-material mdc-typography"],[7],[0,"\\n  "],[6,"nav"],[9,"class","toolbar-nav"],[7],[0,"\\n    "],[6,"a"],[9,"href","https://github.com/cyk/glimmer-material"],[7],[0,"GitHub"],[8],[0,"\\n"],[4,"unless",[[19,0,["isCurrentRouteHome"]]],null,{"statements":[[0,"      "],[6,"a"],[9,"class","back-link"],[9,"href","#"],[7],[0,"Back"],[8],[0,"\\n"]],"parameters":[]},null],[0,"  "],[8],[0,"\\n\\n  "],[1,[25,"component",[[19,0,["currentRouteComponent"]]],[["params"],[[19,0,["params"]]]]],false],[0,"\\n"],[8]],"hasEval":false}',meta:{specifier:"template:/glimmer-material/components/glimmer-material"}},as=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
...
this.adapter_.updateCssVariable(n,this.frame_.width+"px"),this.adapter_.updateCssVariable(i,this.frame_.height+"px"),this.adapter_.updateCssVariable(r,this.initialSize_+"px"),this.adapter_.updateCssVariable(a,this.fgScale_),this.adapter_.isUnbounded()&&(this.unboundedCoords_={left:Math.round(this.frame_.width/2-this.initialSize_/2),top:Math.round(this.frame_.height/2-this.initialSize_/2)},this.adapter_.updateCssVariable(o,this.unboundedCoords_.left+"px"),this.adapter_.updateCssVariable(s,this.unboundedCoords_.top+"px"))},e}(as),ms=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.attachTo=function(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=n.isUnbounded,r=void 0===i?void 0:i,o=new e(t)
