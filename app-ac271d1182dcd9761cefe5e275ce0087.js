...
try{return JSON.stringify(t)}catch(t){}return t.toString()}function Dt(t){return function(e,n){return new fo(t,n)}}function Rt(t,e){t.add("component",wt),e.add("component",Et)}function Bt(t){return void 0!==t.createComponentDefinition}function Mt(){}function Lt(t){var e=t.split(":"),n=e[0],i=e[1]
...
var Te=ve.Debug,De=new Oe({console:xe,level:Te}),Re=Object.keys,Be=0,Me=Object.create(null,{constructor:{value:void 0,enumerable:!1,writable:!0}})
c.prototype=Me
...
var Bn=function(t,e){return new fn(!!t.value())},Mn=function(t,e){return t},Ln=function(t,e){return e.toConditionalReference(t)}
...
try{i=JSON.stringify(n.peek())}catch(t){i=String(n.peek())}return{args:[],details:{expected:i},guid:e,type:t}},e}(Ye),Fn=function(t){function e(n,i){be(this,e)
var r=Se(this,t.call(this))
...
var n=Se(this,t.apply(this,arguments))
return n.type="optimized-trusting-append",n}return ke(e,t),e.prototype.normalize=function(t){return v(t,M)},e.prototype.insert=function(t,e,n){return D(t,e,n)},e.prototype.updateWith=function(t,e,n,i,r){return new _i(n,i,r)},e}(di),_i=function(t){function e(){be(this,e)
var n=Se(this,t.apply(this,arguments))
return n.type="optimized-trusting-update",n}return ke(e,t),e.prototype.insert=function(t,e,n){return D(t,e,n)},e}(yi),ki=I,Si=function(){function t(e,n,i){be(this,t),this.scope=e,this.locals=h()
...
var Oi=function t(e,n){be(this,t),this.start=e,this.end=n},xi=function t(e,n,i){be(this,t),this.start=e,this.end=n,this.symbolTable=i},Ti=function(){function t(e){be(this,t),this.env=e}return t.prototype.wrapLayout=function(t){this.inner=new Di(this.env,t)},t.prototype.fromLayout=function(t,e){this.inner=new Ri(this.env,t,e)},t.prototype.compile=function(){return this.inner.compile()},_e(t,[{key:"tag",get:function(){return this.inner.tag}},{key:"attrs",get:function(){return this.inner.attrs}}]),t}(),Di=function(){function t(e,n){be(this,t),this.env=e,this.layout=n,this.tag=new Bi,this.attrs=new Mi}return t.prototype.compile=function(){var t=this.env,e=this.layout,n={templateMeta:e.meta,symbols:e.symbols,asPartial:!1},i=this.tag.getDynamic(),r=this.tag.getStatic(),o=j(t,n)
...
return new xi(u,p,{meta:n,hasEval:e.hasEval,symbols:e.symbols.concat([Vi])})},t}(),Ri=function(){function t(e,n,i){be(this,t),this.env=e,this.componentName=n,this.layout=i,this.attrs=new Mi}return t.prototype.compile=function(){var t=this.env
return this.layout.asLayout(this.componentName,this.attrs.buffer).compileDynamic(t)},_e(t,[{key:"tag",get:function(){throw new Error("BUG: Cannot call `tag` on an UnwrappedBuilder")}}]),t}(),Bi=function(){function t(){be(this,t),this.isDynamic=null,this.isStatic=null,this.staticTagName=null,this.dynamicTagName=null}return t.prototype.getDynamic=function(){if(this.isDynamic)return this.dynamicTagName},t.prototype.getStatic=function(){if(this.isStatic)return this.staticTagName},t.prototype.static=function(t){this.isStatic=!0,this.staticTagName=t},t.prototype.dynamic=function(t){this.isDynamic=!0,this.dynamicTagName=[Ei.ClientSideExpression,Ni.FunctionExpression,t]},t}(),Mi=function(){function t(){be(this,t),this.buffer=[]}return t.prototype.static=function(t,e){this.buffer.push([Ei.StaticAttr,t,e,null])},t.prototype.dynamic=function(t,e){this.buffer.push([Ei.DynamicAttr,t,[Ei.ClientSideExpression,Ni.FunctionExpression,e],null])},t}(),Li=function(){function t(e){be(this,t),this.builder=e,this.env=e.env}return t.prototype.static=function(t,e){var n=e[0],i=e[1],r=e[2],o=e[3],s=this.builder
...
n?t.getDOM().removeAttributeNS(e,n,i):t.getDOM().removeAttribute(e,i)},e.prototype.updateAttribute=function(t,e,n,i){e[this.attr]=n,vt(n)&&this.removeAttribute(t,e,i)},e}(wr),Ar=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.setAttribute=function(e,n,i){t.prototype.setAttribute.call(this,e,n,Z(e,n,this.attr,i))},e.prototype.updateAttribute=function(e,n,i){t.prototype.updateAttribute.call(this,e,n,Z(e,n,this.attr,i))},e}(Er),Cr=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.prototype.setAttribute=function(t,e,n){e.value=B(n)},e.prototype.updateAttribute=function(t,e,n){var i=e,r=i.value,o=B(n)
...
return Rt(t.blocks,t.inlines),t},i}(Lr),go={id:"UN61+JFU",block:'{"symbols":["root"],"statements":[[4,"each",[[19,0,["roots"]]],[["key"],["id"]],{"statements":[[4,"-in-element",[[19,1,["parent"]]],[["nextSibling"],[[19,1,["nextSibling"]]]],{"statements":[[1,[25,"component",[[19,1,["component"]]],null],false]],"parameters":[]},null]],"parameters":[1]},null]],"hasEval":false}',meta:{specifier:"template:/-application/templates/main"}},bo=function(){function t(e){be(this,t),this._roots=[],this._rootsIndex=0,this._initializers=[],this._initialized=!1,this._rendering=!1,this._rendered=!1,this._scheduled=!1,this._rerender=Mt,this.rootName=e.rootName,this.resolver=e.resolver,this.document=e.document||window.document}return t.prototype.registerInitializer=function(t){this._initializers.push(t)},t.prototype.initRegistry=function(){var t=this._registry=new Ee,e=new ro(this._registry,this.resolver)
...
return e||(e=this.children[t]=new Bo(this.inner,t)),e},e}(fn),Ro=function(t){function e(){return be(this,e),Se(this,t.apply(this,arguments))}return ke(e,t),e.create=function(t,e){return b(t)?new Bo(t.value(),e):new Mo(t,e)},e.prototype.get=function(t){return new Mo(this,t)},e}(To),Bo=function(t){function e(n,i){be(this,e)
var r=Se(this,t.call(this))
return r._parentValue=n,r._propertyKey=i,r.tag=Yt(n,i,Xt),r}return ke(e,t),e.prototype.compute=function(){return this._parentValue[this._propertyKey]},e}(Ro),Mo=function(t){function e(n,i){be(this,e)
